          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center gap-2 sm:gap-4">
                ...
                <button
                  ...
                  className={`px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium transition-all ${
                    selectedCategory === category
                      ...
                      : 'vintage-card text-charcoal dark:text-white hover:bg-charcoal/10 dark:hover:bg-white/10 border border-charcoal/20 dark:border-white/20'
                  }`}
                >
                  {category}
                </button>
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-4 py-2 vintage-card border border-charcoal/20 dark:border-white/20 rounded-lg text-sm text-charcoal dark:text-white focus:outline-none focus:ring-2 focus:ring-gold dark:focus:ring-teal"
              >
                {statuses.map(status => (
